...
"Ensign Babyface! Your shields were failing, sir. This should be interesting.
...
But the probability of making a six is no greater than that of rolling a seven. What? We're not at all alike!
...
var words = ['Ensign', 'everybody'];

const result = words.filter(word => word.length > 6);

console.log(result);
// expected output: Array ['Ensign', 'everybody']